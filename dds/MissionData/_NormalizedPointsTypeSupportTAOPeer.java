package MissionData;
public class _NormalizedPointsTypeSupportTAOPeer extends i2jrt.TAOLocalObject implements NormalizedPointsTypeSupport {
  protected _NormalizedPointsTypeSupportTAOPeer(long ptr) {
    super(ptr);
  }
