package MissionData;
public class _NormalizedPointsDataWriterTAOPeer extends i2jrt.TAOLocalObject implements NormalizedPointsDataWriter {
  protected _NormalizedPointsDataWriterTAOPeer(long ptr) {
    super(ptr);
  }

  public native int register_instance(MissionData.NormalizedPoints instance);

  public native int register_instance_w_timestamp(MissionData.NormalizedPoints instance, DDS.Time_t timestamp);

  public native int unregister_instance(MissionData.NormalizedPoints instance, int handle);

  public native int unregister_instance_w_timestamp(MissionData.NormalizedPoints instance, int handle, DDS.Time_t timestamp);

  public native int write(MissionData.NormalizedPoints instance_data, int handle);

  public native int write_w_timestamp(MissionData.NormalizedPoints instance_data, int handle, DDS.Time_t source_timestamp);

  public native int dispose(MissionData.NormalizedPoints instance_data, int instance_handle);

  public native int dispose_w_timestamp(MissionData.NormalizedPoints instance_data, int instance_handle, DDS.Time_t source_timestamp);
