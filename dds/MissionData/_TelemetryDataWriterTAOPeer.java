package MissionData;
public class _TelemetryDataWriterTAOPeer extends i2jrt.TAOLocalObject implements TelemetryDataWriter {
  protected _TelemetryDataWriterTAOPeer(long ptr) {
    super(ptr);
  }

  public native int register_instance(MissionData.Telemetry instance);

  public native int register_instance_w_timestamp(MissionData.Telemetry instance, DDS.Time_t timestamp);

  public native int unregister_instance(MissionData.Telemetry instance, int handle);

  public native int unregister_instance_w_timestamp(MissionData.Telemetry instance, int handle, DDS.Time_t timestamp);

  public native int write(MissionData.Telemetry instance_data, int handle);

  public native int write_w_timestamp(MissionData.Telemetry instance_data, int handle, DDS.Time_t source_timestamp);

  public native int dispose(MissionData.Telemetry instance_data, int instance_handle);

  public native int dispose_w_timestamp(MissionData.Telemetry instance_data, int instance_handle, DDS.Time_t source_timestamp);
