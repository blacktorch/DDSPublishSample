...
public class DataReaderListenerImpl extends _DataReaderListenerLocalBase {
    ...
    public synchronized void on_data_available(DataReader reader) {
        ...
        NormalizedPointsDataReader normalizedPointsDataReader = NormalizedPointsDataReaderHelper.narrow(reader);//MissionParameterDataReaderHelper.narrow(reader);
        if (normalizedPointsDataReader == null) {
        ...
        int status = normalizedPointsDataReader.take_next_sample(normalizedPointsHolder, sih);
...
//                }
                ...
                for (String data : normalizedPointsHolder.value.points_data){
